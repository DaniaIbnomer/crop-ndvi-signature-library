...
The research investigated the use of satellite-derived vegetation signatures for crop characterisation and irrigation-management applications in the Eastern Nile.
...
This repository contains the public analytical workflow and documentation.

Original Earth Engine study-area boundaries, GPS reference samples, and supporting datasets are maintained separately and are not included in this repository.

The public code is therefore intended primarily for methodological documentation and reproducibility of the analytical approach. Direct execution requires access to the original Earth Engine assets.

...
PUBLIC VERSION
---------------------------------------------------------------
Sensitive/private Earth Engine asset IDs and field GPS datasets
are intentionally not included in this public repository.

To reproduce the workflow, users should provide their own
compatible study-area boundaries, crop reference points,
and supporting raster/vector datasets.
**************************************************************/
